...
if uploaded_file:
    ...
    if confidence < CONF_THRESHOLD:
        ...
        # Informative message before Grad-CAM
        st.subheader("🔬 Showing Diseased Region")
        st.markdown("The heatmap below highlights the region most responsible for the model's prediction.")
